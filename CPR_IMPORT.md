...
Only the latest previous team is retained, using dated stats and transaction history, with undated history as a fallback. Grade follows the bot's age/redshirt-history mapping. Years left includes the upcoming season: FR 4, SO 3, JR 2, SR 1. Redshirt grades have the same remaining years as their non-redshirt counterparts. Unknown grades remain blank.
